...
from src.components.attendance_result_dialog import attendance_result_dialog, show_attendance_result
import numpy as np
...
def teacher_tab_manage_subjects():
    ...
    if subjects:
        for sub in subjects:
            stats = [
               ("🫂", "Students", f":black[{sub['total_students']}]"),
...
def teacher_screen_login():
    ...
    st.space()
    st.space()
    teacher_username = st.text_input("Enter Username",placeholder="Ananya")
    teacher_password = st.text_input("Password", type="password",placeholder="Ananya")
    st.divider()
...
def teacher_screen_register():
    ...
    teacher_password = st.text_input("Password", type="password",placeholder="Ananya")
    teacher_password_confirm = st.text_input("Confirm your Password", type="password",placeholder="Ananya")
    st.divider()
    btnc1,btnc2=st.columns(2)
    with btnc1:
